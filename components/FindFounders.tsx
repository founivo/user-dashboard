...
const founders = [
  ...
  { name: "Lena Müller", role: "CEO", company: "ClimateOps", industry: "ClimaTech", stage: "Seed", location: "Berlin", tags: ["ClimaTech", "B2B"], avatar: "LM", rating: 4.6, views: 122, meetings: 15, available: true, verified: false, bio: "Climate tech CEO building carbon management tools for enterprise. YC S22 alumni." },
  { name: "David Kim", role: "Co-founder", company: "CryptoEdge", industry: "Web3", stage: "Pre-seed", location: "Singapore", tags: ["Web3", "DeFi"], avatar: "DK", rating: 4.5, views: 98, meetings: 11, available: false, verified: true, bio: "Web3 builder since 2017. Co-founded 3 blockchain protocols. Deep expertise in DeFi and tokenomics." },
];
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }} className="fade-in">
      ...
      <div>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: 14, marginTop: 4 }}>
          Connect with over {founders.length}+ elite verified founders in our directory
        </p>
      </div>
        ...
        <div className="filters-wrapper">
          ...
          <div style={{ flex: 1, position: "relative" }}>
            ...
            <input 
              ...
              style={{ paddingLeft: 38, height: 42, fontSize: 13, background: "var(--bg-soft)", border: "1px solid var(--border)" }} 
            />
          </div>
